...
<article>
    <main>
        ...
        <section class="section propos">
            <h2 class="propos__titre"><?php the_field('about-title'); ?></h2>
            <div class="propos__grid">
                <div class="propos__mission">
                    <h3 class="propos__mission"><?php the_field('mission-title'); ?></h3>
                    <p class="propos__p">
                        <?php the_field('mission'); ?>
                    </p>
                </div>
                <div class="propos__approche">
                    <h3 class="propos__approche"><?php the_field('approche-title'); ?></h3>
                    <p class="propos__p">
        ...
        <section class="section__services">
            <div class="services__container">
                <h2 class="services__titre"><a href="services-hub.html"><?php the_field('service-title'); ?></a></h2>
        ...
        <section class="news-section">
            <h2 class="titre-news"><?php the_field('news-title'); ?></h2>
            ...
            <h3 class="titre voir-plus">
                <?php
                // Remplacez 123 par l'ID de votre page cible
                $page_url = get_permalink(22);
                ?>
                <a href="<?php echo esc_url($page_url); ?>">Voir toutes les publications</a>
            </h3>
        </section>
        ...
        <section class="section info-lettre">
            <div class="info-lettre__form">
                <h2 class="info-lettre__titre"><?php the_field('info-lettre'); ?></h2>
